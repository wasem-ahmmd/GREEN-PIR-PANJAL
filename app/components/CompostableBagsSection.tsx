...
const items = [
  {
    ...
    title: "Bio",
    highlight: "Polymers",
    image: "/images/bio-polymers.png",
    imageAlt: "Bio polymer research and formulation at Green Pir Panjal R&D",
    badge: { label: "Bio Polymers", value: "Renewable Polymer Core" },
    imageOnLeft: true,
    desc: "Our bio-polymer platform engineers advanced biodegradable materials from renewable biomass — starches, cellulose and regional agricultural residues. We formulate polymers that match conventional plastic in strength and flexibility, while breaking down safely in soil and compost within months, not centuries.",
    points: [
      "Custom bio-polymer blends for bags, films and packaging",
      "Derived from plant feedstocks — zero petroleum inputs",
      "Lab-tested for strength, flexibility and full biodegradability",
      "Scalable formulations ready for pilot and industrial runs",
    ],
  },
  {
    tag: "// Our Product",
    ...
    image: "/images/compostable-bags.png",
    imageAlt: "Eco-friendly compostable bags by Green Pir Panjal R&D",
    badge: { label: "100% Compostable", value: "2-Year Breakdown" },
    imageOnLeft: false,
    desc: "We engineer compostable bags from plant-based polymers and regional agricultural by-products — durable, plastic-free bags designed for everyday use and safe breakdown within 2 years under compost conditions.",
    points: [
      "Plant-derived biodegradable polymers",
      "Fully compostable within 2 years",
